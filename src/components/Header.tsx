      ...
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pars-gold to-pars-bronze flex items-center justify-center">
            <span className="text-xl font-bold text-pars-deep">F</span>
          </div>
          <div>
            <span className="text-xl font-bold gradient-text">PARSIS Fund</span>
            <span className="text-xs text-white/50 block">Community Investment</span>
          </div>
        </Link>
